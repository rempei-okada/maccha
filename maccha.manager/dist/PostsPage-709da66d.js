...
import { F as FlexSpacer, I as ItemsWrapGrid } from './ColorPalette-143c647b.js';
import { C as Checkbox, s as showDialogAsync } from './showDialog-7310d02a.js';
import { F as FileCopy, W as WrappedTextBlock } from './WrappedTextBlock-337459ec.js';
import { o as observer } from './mobxreact.esm-9c7559e4.js';
import { findDOMNode, unstable_batchedUpdates } from 'react-dom';
import { F as Fab } from './Fab-ba37f354.js';
import { p as postStatusTypeDisplay } from './PostStatusType-46fd11ad.js';
import { C as Card } from './Card-8eda5186.js';
import { c as confirmAsync } from './confirmAsync-5da1581e.js';
import { T as TableContainer, a as Table, b as TableHead, c as TableRow, d as TableCell, e as TableBody } from './TableRow-6c61b599.js';
...
function PostCardMenu(props) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(Fab, __assign({ color: "secondary", size: "small" }, { children: jsxRuntime.jsx(Icon, { children: "toc" }, void 0) }), void 0),
            jsxRuntime.jsxs(Planet, __assign({ color: theme.palette.secondary.light, autoClose: true, angle: 270, rotation: -90, orbitRadius: 72, radius: 72 * 0.6666, onClose: function () { return setIsMenuOpened(false); }, open: isMenuOpened, centerContent: jsxRuntime.jsx(Fab, __assign({ color: "secondary", size: "small" }, { children: jsxRuntime.jsx(Icon, { children: "toc" }, void 0) }), void 0) }, { children: [!props.disableDeleteButton && jsxRuntime.jsx(IconButton, __assign({ disabled: props.disableDeleteButton, color: "inherit", style: { color: "white" }, size: "small", onClick: function () { return deletePresed(); } }, { children: jsxRuntime.jsx(Icon, { children: "delete" }, void 0) }), void 0),
                    ...
                    !props.disableEditButton && jsxRuntime.jsx(IconButton, __assign({ disabled: props.disableEditButton, color: "inherit", style: { color: "white" }, size: "small", onClick: function () { return editPressed(); } }, { children: jsxRuntime.jsx(Icon, { children: "edit" }, void 0) }), void 0)] }), void 0)] }, void 0));
}
