...
import { F as FlexSpacer, I as ItemsWrapGrid } from './ColorPalette-2db4de3a.js';
import { C as Checkbox, s as showDialogAsync } from './showDialog-efa64b8a.js';
...
import { F as Fab } from './Fab-9313a008.js';
import { p as postStatusTypeDisplay } from './PostStatusType-61c7b669.js';
import { C as Card } from './Card-700f586c.js';
...
function PostCardMenu(props) {
    ...
    return (jsxRuntime.jsxs(Planet, __assign({ color: theme.palette.secondary.light, autoClose: true, angle: 270, rotation: -90, orbitRadius: 72, radius: 72 * 0.6666, onClose: function () { return setIsMenuOpened(false); }, open: isMenuOpened, centerContent: jsxRuntime.jsx(Fab, __assign({ color: "secondary", size: "small", onClick: function () { return setIsMenuOpened(true); }, style: {
