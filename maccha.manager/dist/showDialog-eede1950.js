...
import { w as withStyles, _ as _objectWithoutProperties, C as useControlled, D as _slicedToArray, t as useFormControl, I as IconButton, a as _extends, c as clsx, p as propTypes, x as refType, b as createSvgIcon, G as fade, e as capitalize, a5 as _defineProperty, a6 as Modal, a7 as Backdrop, P as Paper, a8 as Fade, a9 as duration, n as makeStyles, aa as createStyles, k as jsxRuntime, ab as ThemeProvider, m as __assign, U as theme, g as __read, ac as useMediaQuery, ad as Grow, K as Box, T as Typography } from './index.lib-fcf45d4b.js';
...
function DialogBase(props) {
    ...
    return (jsxRuntime.jsx(Dialog$1, __assign({ TransitionComponent: Grow, open: isOpen, disableBackdropClick: true, disableEscapeKeyDown: true, maxWidth: props.maxWidth, fullWidth: true, fullScreen: matches, container: props.element }, { children: jsxRuntime.jsx(DialogContent$1, __assign({ style: { padding: "0px" } }, { children: jsxRuntime.jsx(props.content, { onClose: function (e) { return onClose(e); }, context: props.context }, void 0) }), void 0) }), void 0));
}
function showDialogAsync(component, context, option) {
    return new Promise(function (resolve) {
        ...
        render(jsxRuntime.jsx(ThemeProvider, __assign({ theme: theme }, { children: jsxRuntime.jsx(DialogBase, { onClose: onClose, content: component, context: context, element: element, maxWidth: option === null || option === void 0 ? void 0 : option.maxWidth }, void 0) }), void 0), element);
    });
}
function DialogContentFrame(props) {
    return (jsxRuntime.jsxs(Box, { children: [jsxRuntime.jsxs(Box, __assign({ p: 3 }, { children: [props.message &&
                        jsxRuntime.jsx(Box, { children: jsxRuntime.jsx(Typography, __assign({ variant: "h6" }, { children: props.message }), void 0) }, void 0),
                    props.description &&
                        jsxRuntime.jsx(Box, __assign({ mt: 3 }, { children: jsxRuntime.jsx(Typography, __assign({ variant: "overline", color: "textSecondary" }, { children: props.description }), void 0) }), void 0),
                    props.children &&
                        jsxRuntime.jsx(Box, __assign({ my: 3 }, { children: props.children }), void 0)] }), void 0),
            jsxRuntime.jsx(Box, __assign({ p: 1 }, { children: props.actions && jsxRuntime.jsx(DialogActions$1, { children: props.actions }, void 0) }), void 0)] }, void 0));
}
