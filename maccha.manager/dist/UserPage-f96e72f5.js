import { b as createSvgIcon, w as withStyles, M as fade, b1 as emphasize, _ as _objectWithoutProperties, A as useForkRef, c as clsx, e as capitalize, a as _extends, p as propTypes, aP as unsupportedProp, N as ButtonBase, m as makeStyles, i as __awaiter, j as __generator, k as _assign, g as __read, h as useObserver, R as Box, T as Typography, S as Select, b0 as displayRoles, ah as MenuItem, aa as RoleType, af as ListItemText, B as Button, s as services, u as useTheme, aZ as Toolbar, P as Paper, Q as InputBase, I as IconButton, a8 as Avatar, V as axios, a7 as Icon, b2 as User } from './index-e5acb89e.js';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import React, { createElement, forwardRef, useRef, isValidElement, cloneElement, useState, useEffect } from 'react';
import { s as showDialogAsync, C as Checkbox } from './showDialog-0ec92b71.js';
...
function UserDetailDialog(props) {
    ...
    function setUserParam(key, value) {
        var _a;
        setUser(_assign(_assign({}, user), (_a = {}, _a[key] = value, _a)));
        if (key === "name") {
            if (!value.length) {
    ...
    return useObserver(function () {
        ...
        return (jsxs(Box, _assign({ p: 3, display: "flex", height: "100%", flexDirection: "column", justifyContent: "space-between" }, { children: [jsx(Typography, _assign({ variant: "h5" }, { children: "\u30E6\u30FC\u30B6\u30FC\u7DE8\u96C6" }), void 0),
                jsxs(Box, { children: [jsx(Typography, _assign({ style: { marginTop: "24px" } }, { children: "\u540D\u524D" }), void 0),
                        ...
                        jsx(Typography, _assign({ style: { marginTop: "24px" } }, { children: "E-Mail" }), void 0),
                        ...
                        props.context.password !== undefined && jsxs(Fragment, { children: [jsx(Typography, _assign({ style: { marginTop: "24px" } }, { children: "Password" }), void 0),
                        ...
                        jsx(Typography, _assign({ style: { marginTop: "24px" } }, { children: "\u6A29\u9650" }), void 0),
                        jsx(Select, _assign({ fullWidth: true, value: user.role, onChange: function (e) {
                                setUser(_assign(_assign({}, user), { role: Number(e.target.value) }));
                                setCanClose(true);
                            } }, { children: Object.keys(displayRoles).map(function (role, key) { return jsx(MenuItem, _assign({ value: role }, { children: displayRoles[role] }), key); }) }), void 0),
                        jsx(Typography, _assign({ style: { marginTop: "24px" } }, { children: "\u6709\u52B9\u6027" }), void 0),
                        jsx(Switch, { checked: user.isActive, color: "primary", onChange: function (e) {
                                setUser(_assign(_assign({}, user), { isActive: !user.isActive }));
                                setCanClose(true);
                            } }, void 0),
                        user.role !== RoleType.Admin &&
                            jsxs(Fragment, { children: [jsx(Typography, _assign({ style: { marginTop: "24px" } }, { children: "\u8A31\u53EF\u3059\u308B\u30B5\u30A4\u30C8" }), void 0),
                                    jsx(Select, _assign({ fullWidth: true, multiple: true, value: user.identifiers, onChange: function (e) {
                                            setUser(_assign(_assign({}, user), { identifiers: e.target.value }));
                                            setCanClose(true);
                                        }, renderValue: function (selected) { return (jsx("div", { children: selected.map(function (value, key) { return (jsx(Chip$1, { color: "primary", style: { marginLeft: "4px" }, label: value }, key)); }) }, void 0)); } }, { children: webSiteManagementsService.webSites.map(function (site, key) { return (jsxs(MenuItem, _assign({ value: site.webSiteId }, { children: [jsx(Checkbox, { color: "primary", checked: user.identifiers.includes(site.webSiteId) }, void 0),
                                                jsxs(ListItemText, { children: [site.webSiteId, " - ", site.name] }, void 0)] }), key)); }) }), void 0)] }, void 0)] }, void 0),
                jsxs(Box, _assign({ marginTop: "24px", marginBottom: "12px", display: "flex" }, { children: [jsx(Button, _assign({ variant: "text", color: "primary", style: { marginLeft: "auto" }, onClick: function () { return props.onClose(undefined); } }, { children: "Cancel" }), void 0),
                        jsx(Button, _assign({ disabled: !canClose, variant: "contained", style: { marginLeft: "12px" }, onClick: function () { return props.onClose(user); }, color: "primary" }, { children: "Ok" }), void 0)] }), void 0)] }), void 0));
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, showDialogAsync(UserDetailDialog, _assign({ password: "" }, user))];
...
function UsersPage() {
    ...
    return useObserver(function () {
        ...
        return (jsxs(Box, _assign({ p: 2, height: "100%", display: "flex", flexDirection: "column" }, { children: [jsxs(Toolbar, _assign({ style: { paddingRight: "0" } }, { children: [jsxs(Paper, _assign({ style: { marginLeft: "auto" }, elevation: 2 }, { children: [jsx(InputBase, { style: {
                                        marginLeft: theme.spacing(2),
                                        flex: 1,
                                    }, placeholder: "\u691C\u7D22", inputProps: { "aria-label": "検索" } }, void 0),
                                jsx(IconButton, _assign({ type: "submit", style: { padding: "10px" }, "aria-label": "search" }, { children: jsx(Search, {}, void 0) }), void 0)] }), void 0),
                        jsxs(Button, _assign({ variant: "contained", style: {
                                marginLeft: "8px",
                                height: "44px",
                                borderRadius: "22px"
                            }, color: "primary", onClick: function () { return createAsync(); } }, { children: [jsx(Add, {}, void 0), "\u8FFD\u52A0"] }), void 0)] }), void 0),
                jsx(Paper, _assign({ className: classes.root, elevation: 2 }, { children: jsx(TableContainer, _assign({ className: classes.container }, { children: jsxs(Table, _assign({ stickyHeader: true, "aria-label": "sticky table" }, { children: [jsx(TableHead, { children: jsxs(TableRow, { children: [jsx(TableCell, {}, void 0),
                                            jsx(TableCell, {}, void 0),
                                            jsx(TableCell, { children: "Name" }, void 0),
                                            jsx(TableCell, { children: "E-Mail" }, void 0),
                                            jsx(TableCell, _assign({ width: "500px" }, { children: "Web Site" }), void 0),
                                            jsx(TableCell, _assign({ style: { textAlign: "center" } }, { children: "Role" }), void 0),
                                            jsx(TableCell, { children: "Enabled" }, void 0),
                                            jsx(TableCell, _assign({ style: { textAlign: "center" } }, { children: "Detail" }), void 0)] }, void 0) }, void 0),
                                jsx(TableBody, { children: usersService.users.map(function (user, i) { return (jsxs(TableRow, { children: [jsx(TableCell, _assign({ padding: "checkbox" }, { children: jsx(Checkbox, { color: "primary" }, void 0) }), void 0),
                                            ...
                                            jsx(TableCell, { children: jsx(Box, _assign({ style: { display: "flex", flexWrap: "wrap" } }, { children: user.role === RoleType.Admin ?
                                                        jsx(Box, _assign({ padding: "4px" }, { children: jsx(Chip$1, { color: "primary", label: "\u7BA1\u7406\u8005" }, void 0) }), void 0)
                                                        :
                                                            user.identifiers.slice(0, 6).map(function (identifier) { return (jsx(Box, _assign({ padding: "4px" }, { children: jsx(Chip$1, { color: "primary", label: identifier }, void 0) }), void 0)); }) }), void 0) }, void 0),
                                            jsx(TableCell, _assign({ style: { textAlign: "center" } }, { children: displayRoles[user.role] }), void 0),
                                            jsx(TableCell, { children: user.isActive ? "有効" : "無効" }, void 0),
                                            jsx(TableCell, _assign({ style: { textAlign: "center" } }, { children: jsx(IconButton, _assign({ onClick: function () { return editEsync(user); } }, { children: jsx(Icon, { children: "list" }, void 0) }), void 0) }), void 0)] }, user.email)); }) }, void 0)] }), void 0) }), void 0) }), void 0)] }), void 0));
    });
}
