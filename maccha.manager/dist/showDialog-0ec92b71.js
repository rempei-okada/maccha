import { w as withStyles, _ as _objectWithoutProperties, J as useControlled, K as _slicedToArray, r as useFormControl, I as IconButton, a as _extends, c as clsx, p as propTypes, v as refType, b as createSvgIcon, M as fade, e as capitalize, al as _defineProperty, am as Modal, an as Backdrop, P as Paper, ao as Fade, ap as duration, m as makeStyles, aq as createStyles, ar as ThemeProvider, k as _assign, a9 as theme, g as __read, as as useMediaQuery, at as Grow, R as Box, T as Typography } from './index-e5acb89e.js';
...
function DialogBase(props) {
    ...
    return (jsx(Dialog$1, _assign({ TransitionComponent: Grow, open: isOpen, disableBackdropClick: true, disableEscapeKeyDown: true, maxWidth: props.maxWidth, fullWidth: true, fullScreen: matches, container: props.element }, { children: jsx(DialogContent$1, _assign({ style: { padding: "0px" } }, { children: jsx(props.content, { onClose: function (e) { return onClose(e); }, context: props.context }, void 0) }), void 0) }), void 0));
}
function showDialogAsync(component, context, option) {
    return new Promise(function (resolve) {
        ...
        render(jsx(ThemeProvider, _assign({ theme: theme }, { children: jsx(DialogBase, { onClose: onClose, content: component, context: context, element: element, maxWidth: option === null || option === void 0 ? void 0 : option.maxWidth }, void 0) }), void 0), element);
    });
}
function DialogContentFrame(props) {
    return (jsxs(Box, { children: [jsxs(Box, _assign({ p: 3 }, { children: [props.message &&
                        jsx(Box, { children: jsx(Typography, _assign({ variant: "h6" }, { children: props.message }), void 0) }, void 0),
                    props.description &&
                        jsx(Box, _assign({ mt: 3 }, { children: jsx(Typography, _assign({ variant: "overline", color: "textSecondary" }, { children: props.description }), void 0) }), void 0),
                    props.children &&
                        jsx(Box, _assign({ my: 3 }, { children: props.children }), void 0)] }), void 0),
            jsx(Box, _assign({ p: 1 }, { children: props.actions && jsx(DialogActions$1, { children: props.actions }, void 0) }), void 0)] }, void 0));
}
