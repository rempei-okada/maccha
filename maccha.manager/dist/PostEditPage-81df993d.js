import { aT as _inheritsLoose, $ as _objectWithoutPropertiesLoose, aU as Transition, a as _extends, aV as classNamesShape, p as propTypes, m as makeStyles, w as withStyles, _ as _objectWithoutProperties, c as clsx, B as Button, aq as createStyles, aW as Popover, I as IconButton, T as Typography, aG as _classCallCheck, aF as _createClass, aX as TransitionGroup, u as useTheme, aY as SvgIcon, al as _defineProperty, K as _slicedToArray, M as fade, aZ as Toolbar, aD as createCommonjsModule, aE as unwrapExports, Y as _typeof, ac as useRouteMatch, f as useHistory, g as __read, R as Box, k as _assign, S as Select, ah as MenuItem, U as Divider, a_ as StatusType, a$ as luxon_1, V as axios, i as __awaiter, j as __generator, a7 as Icon, s as services, ad as ObserverComponent } from './index-e5acb89e.js';
import { jsxs, Fragment as Fragment$1, jsx } from 'react/jsx-runtime';
import React, { useMemo, createElement, createContext, useContext, useEffect, useLayoutEffect, Fragment, useRef, Component, useCallback, cloneElement, useState, forwardRef, useDebugValue } from 'react';
import { c as confirmAsync } from './confirmAsync-7fe9fc93.js';
import { _ as _inherits, a as _possibleConstructorReturn, b as _getPrototypeOf, s as showMediaSelectionDialog, e as editors } from './index-c5b71096.js';
import { a as postStatusTypes } from './PostStatusType-a2d9dc4e.js';
import { S as Switch } from './Switch-c56f04cc.js';
import { a as Dialog, b as DialogContent, c as DialogActions } from './showDialog-0ec92b71.js';
import { C as CircularProgress } from './ColorPalette-836d6e43.js';
import { I as InputAdornment } from './InputAdornment-a9380ce9.js';
...
var KeyboardDateInput = function KeyboardDateInput(_ref) {
  ...
  return /*#__PURE__*/createElement(Rifm, {
    ...
    return /*#__PURE__*/createElement(TextFieldComponent, _extends({
      ...
      onChange: onChange,
      variant: inputVariant,
      InputProps: _objectSpread$1$1({}, InputProps, _defineProperty({}, "".concat(position, "Adornment"), /*#__PURE__*/createElement(InputAdornment, _extends({
        position: position
...
var addDays = unwrapExports(addDays_1);
...
var addSeconds = unwrapExports(addSeconds_1);
...
var addMinutes = unwrapExports(addMinutes_1);
...
var addHours = unwrapExports(addHours_1);
...
var addWeeks = unwrapExports(addWeeks_1);
...
var addMonths = unwrapExports(addMonths_1);
...
var addYears = unwrapExports(addYears_1);
...
unwrapExports(differenceInCalendarYears_1);
...
var differenceInYears = unwrapExports(differenceInYears_1);
...
var endOfDay = unwrapExports(endOfDay_1);
...
var endOfMonth = unwrapExports(endOfMonth_1);
...
unwrapExports(isLastDayOfMonth_1);
...
var differenceInMonths = unwrapExports(differenceInMonths_1);
...
var differenceInQuarters = unwrapExports(differenceInQuarters_1);
...
var startOfDay = unwrapExports(startOfDay_1);
...
unwrapExports(differenceInCalendarDays_1);
...
var differenceInDays = unwrapExports(differenceInDays_1);
...
var differenceInWeeks = unwrapExports(differenceInWeeks_1);
...
var differenceInMilliseconds = unwrapExports(differenceInMilliseconds_1);
...
var differenceInHours = unwrapExports(differenceInHours_1);
...
var differenceInMinutes = unwrapExports(differenceInMinutes_1);
...
var differenceInSeconds = unwrapExports(differenceInSeconds_1);
...
var eachDayOfInterval = unwrapExports(eachDayOfInterval_1);
...
var endOfWeek = unwrapExports(endOfWeek_1);
...
var endOfYear = unwrapExports(endOfYear_1);
...
var defaultLocale = unwrapExports(enUS);
...
var getHours$1 = unwrapExports(getHours_1);
...
var getSeconds = unwrapExports(getSeconds_1);
...
var getYear = unwrapExports(getYear_1);
...
var isAfter = unwrapExports(isAfter_1);
...
var isBefore = unwrapExports(isBefore_1);
...
var isSameDay = unwrapExports(isSameDay_1);
...
var isSameYear = unwrapExports(isSameYear_1);
...
var isSameMonth = unwrapExports(isSameMonth_1);
...
var isSameHour = unwrapExports(isSameHour_1);
...
var dateFnsParse = unwrapExports(parse_1);
...
var setHours = unwrapExports(setHours_1);
...
var setMinutes = unwrapExports(setMinutes_1);
...
var getDaysInMonth = unwrapExports(getDaysInMonth_1);
...
var setMonth = unwrapExports(setMonth_1);
...
var getDay = unwrapExports(getDay_1);
...
var setSeconds = unwrapExports(setSeconds_1);
...
var setYear = unwrapExports(setYear_1);
...
var startOfMonth = unwrapExports(startOfMonth_1);
...
var startOfWeek = unwrapExports(startOfWeek_1);
...
var startOfYear = unwrapExports(startOfYear_1);
...
var isWithinInterval = unwrapExports(isWithinInterval_1);
...
function PostEditOptionPanel(props) {
    ...
    var _c = __read(useState(!!props.contentEditContext.publishIn), 2), isReservationed = _c[0], setIsReservation = _c[1];
    ...
    return (jsxs(Fragment$1, { children: [jsxs(Box, _assign({ width: "100%", display: "flex", mt: 1 }, { children: [jsx(Select, _assign({ color: "primary", style: { flex: "1 1 auto" }, value: contentEditContext.status, onChange: function (e) { return setcontentEditContextParam("status", e.target.value); } }, { children: postStatusTypes.map(function (t) { return (jsx(MenuItem, _assign({ value: t.value }, { children: t.display }), t.value)); }) }), void 0),
                    jsx(Button, _assign({ style: { marginLeft: "8px" }, onClick: publishAsync, color: "primary", variant: "contained" }, { children: "\u6295\u7A3F" }), void 0)] }), void 0),
            jsx(Box, _assign({ mt: 3 }, { children: jsx(Divider, {}, void 0) }), void 0),
            contentEditContext.status !== StatusType.Drafting && (jsxs(Box, _assign({ width: "100%", mt: 3 }, { children: [jsx(Typography, _assign({ color: "textSecondary" }, { children: "\u516C\u958B\u6642\u9593\u4E88\u7D04" }), void 0),
                    jsxs(Box, _assign({ display: "flex", alignItems: "center" }, { children: [jsx(Switch, { color: "primary", checked: isReservationed, onChange: function (e) {
                                    setcontentEditContextParam("publishIn", luxon_1.local());
                                    setIsReservation(e.target.checked);
                                } }, void 0), isReservationed ? "ON" : "OFF"] }), void 0),
                    isReservationed && jsx(Fragment$1, { children: jsxs(MuiPickersUtilsProvider, _assign({ utils: DateFnsUtils }, { children: [jsx(KeyboardDatePicker, { margin: "normal", id: "date-picker-dialog", label: "\u516C\u958B\u65E5", format: "MM/dd/yyyy", value: (_a = contentEditContext.publishIn) === null || _a === void 0 ? void 0 : _a.toJSDate(), onChange: function (e) { var _a; return setcontentEditContextParam("publishIn", luxon_1.fromISO((_a = e === null || e === void 0 ? void 0 : e.toISOString()) !== null && _a !== void 0 ? _a : "")); }, KeyboardButtonProps: {
                                        "aria-label": "change date",
                                    } }, void 0),
                                jsx(KeyboardTimePicker, { margin: "normal", id: "time-picker", label: "\u516C\u958B\u6642\u9593", value: (_b = contentEditContext.publishIn) === null || _b === void 0 ? void 0 : _b.toJSDate(), onChange: function (e) { var _a; return setcontentEditContextParam("publishIn", luxon_1.fromISO((_a = e === null || e === void 0 ? void 0 : e.toISOString()) !== null && _a !== void 0 ? _a : "")); }, KeyboardButtonProps: {
                                        "aria-label": "change time",
                                    } }, void 0)] }), void 0) }, void 0)] }), void 0)),
            jsxs(Box, _assign({ width: "100%", mt: 3 }, { children: [jsx(Typography, _assign({ color: "textSecondary", variant: "overline" }, { children: "\u30BF\u30A4\u30C8\u30EB" }), void 0),
                    jsx(TextField, { onChange: function (e) { return setcontentEditContextParam("title", e.target.value); }, placeholder: "\u65B0\u3057\u3044\u6295\u7A3F\u3067\u3059", fullWidth: true, value: contentEditContext.title, color: "primary" }, void 0)] }), void 0),
            jsxs(Box, _assign({ width: "100%", mt: 2 }, { children: [jsxs(Box, _assign({ display: "flex" }, { children: [jsx(Typography, _assign({ color: "textSecondary", variant: "overline" }, { children: "\u30B5\u30E0\u30CD\u30A4\u30EB" }), void 0),
                            jsx(Button, _assign({ variant: "text", color: "primary", size: "small", disabled: !contentEditContext.thumbnail, style: { marginLeft: "auto" }, onClick: function () { return setcontentEditContextParam("thumbnail", ""); } }, { children: "\u30AF\u30EA\u30A2" }), void 0)] }), void 0),
                    jsxs(Box, _assign({ height: "120px", width: "100%", mt: 1, overflow: "hidden", style: {
                            position: "relative",
                            borderRadius: "2px",
                            background: "rgba(127,127,127,0.09)",
                        } }, { children: [contentEditContext.thumbnail && jsx("img", { alt: "thumbnail", style: {
                                    height: "100%",
                                    width: "100%",
                                    objectFit: "cover",
                                    WebkitUserSelect: "none"
                                }, src: axios.defaults.baseURL + contentEditContext.thumbnail }, void 0),
                            jsx(Button, _assign({ variant: "text", color: "primary", onClick: function () { return selectMedia(); }, style: {
                                    position: "absolute",
                                    left: 0,
                                    right: 0,
                                    bottom: 0,
                                    ...
                                    height: "120px",
                                    width: "100%"
                                } }, { children: jsx(Icon, { children: "add" }, void 0) }), void 0)] }), void 0)] }), void 0),
            jsxs(Box, _assign({ mt: 2 }, { children: [jsx(Typography, _assign({ color: "textSecondary", variant: "overline" }, { children: "\u5099\u8003" }), void 0),
                    jsx(TextField, { multiline: true, rows: 6, variant: "filled", hiddenLabel: true, fullWidth: true, value: contentEditContext.description, onChange: function (e) { return setcontentEditContextParam("description", e.target.value); } }, void 0)] }), void 0),
            jsxs(Box, _assign({ mt: 2 }, { children: [jsx(Typography, _assign({ color: "textSecondary", variant: "overline" }, { children: "\u30E1\u30BF\u30C7\u30FC\u30BF" }), void 0),
                    jsx(TextField, { multiline: true, rows: 6, variant: "filled", hiddenLabel: true, fullWidth: true, value: contentEditContext.metadata, onChange: function (e) { return setcontentEditContextParam("metadata", e.target.value); } }, void 0)] }), void 0)] }, void 0));
}
...
function FieldEditor(props) {
    ...
    if (Element) {
        return (jsx(Element, { field: field, onChange: props.onChange }, void 0));
    }
...
function PostEditPage() {
    ...
    return jsx(ObserverComponent, { children: function () {
            ...
            return postEditService.content && (jsxs(Box, _assign({ display: "flex", position: "relative", height: "100%" }, { children: [jsx(Box, _assign({ p: 2, flex: "1 1 auto", overflow: "hidden", height: "100%", style: { overflowY: "auto" }, display: "flex", alignItems: "center", flexDirection: "column" }, { children: (_a = services.postManagementsService.selected) === null || _a === void 0 ? void 0 : _a.taxonomy.schemes.map(function (scheme) {
                            var _a;
                            var f = (_a = postEditService.content) === null || _a === void 0 ? void 0 : _a.fields.find(function (s) { return s.schemeId === scheme.schemeId; });
                            if (!f) {
                                return jsxs(Box, _assign({ className: "post", maxWidth: "100%", width: "780px", mt: 2 }, { children: [jsxs(Typography, _assign({ color: "error" }, { children: ["\"", scheme.name, " - ", scheme.displayName, "\" \u306E\u8AAD\u307F\u8FBC\u307F\u306B\u5931\u6557\u3057\u307E\u3057\u305F"] }), void 0),
                                        jsx(Box, { mt: 2 }, void 0),
                                        jsx(Divider, {}, void 0)] }), scheme.schemeId);
                            }
                            return jsxs(Box, _assign({ className: "post", maxWidth: "100%", width: "780px", mt: 2 }, { children: [jsxs(Typography, _assign({ variant: "h5", style: { wordBreak: "break-all" } }, { children: [scheme.name, " - ", scheme.displayName] }), void 0),
                                    jsx(Divider, {}, void 0),
                                    jsx(Box, { mt: 2 }, void 0),
                                    jsx(Typography, _assign({ color: "textSecondary", variant: "caption" }, { children: scheme.description }), void 0),
                                    jsx(Box, { mt: 2 }, void 0),
                                    jsx(FieldEditor, { onChange: function (e) { return handleChangeField(e); }, field: {
                                            field: f,
                                            scheme: scheme
                                        } }, void 0),
                                    jsx(Box, { mt: 4 }, void 0)] }), scheme.schemeId);
                        }) }), void 0),
                    jsx(Divider, { orientation: "vertical" }, void 0),
                    jsx(Box, _assign({ p: 2, minWidth: "300px", maxWidth: "300px", overflow: "auto" }, { children: jsx(PostEditOptionPanel, { contentEditContext: postEditService.content }, void 0) }), void 0)] }), void 0));
        } }, void 0);
}
