import { m as makeStyles, i as __awaiter, j as __generator, g as __read, a4 as ObserverComponent, R as Box, k as __assign, T as Typography, B as Button, u as useTheme, s as services, h as useObserver, aQ as Toolbar, P as Paper, Q as InputBase, I as IconButton, Z as Icon, aW as WebSite } from './index-ef27c13e.js';
import { jsx, jsxs } from 'react/jsx-runtime';
import React, { useState, useEffect } from 'react';
import { s as showDialogAsync, C as Checkbox } from './showDialog-ce430e7c.js';
import { T as TextField } from './TextField-d5a06b92.js';
import { S as Search, T as TableContainer, a as Table, b as TableHead, c as TableRow, d as TableCell, e as TableBody } from './Search-7e7baac5.js';
...
function WebSiteDetailDialog(props) {
    ...
    return (jsx(ObserverComponent, { children: function () {
            return jsxs(Box, __assign({ p: 3, display: "flex", height: "100%", flexDirection: "column", justifyContent: "space-between" }, { children: [jsx(Typography, __assign({ variant: "h5" }, { children: "\u30E6\u30FC\u30B6\u30FC\u7DE8\u96C6" }), void 0),
                    jsxs(Box, { children: [jsx(Typography, __assign({ style: { marginTop: "24px" } }, { children: "WEB\u30B5\u30A4\u30C8\u540D" }), void 0),
                            ...
                            jsx(Typography, __assign({ style: { marginTop: "24px" } }, { children: "\u8B58\u5225\u540D" }), void 0),
                            ...
                            jsx(Typography, __assign({ style: { marginTop: "24px" } }, { children: "\u30DB\u30B9\u30C8\u30A2\u30C9\u30EC\u30B9" }), void 0),
                            ...
                            jsx(Typography, __assign({ style: { marginTop: "24px" } }, { children: "\u5099\u8003" }), void 0),
                    ...
                    jsxs(Box, __assign({ marginTop: "24px", marginBottom: "12px", display: "flex" }, { children: [jsx(Button, __assign({ variant: "text", color: "primary", style: { marginLeft: "auto" }, onClick: function () { return props.onClose(undefined); } }, { children: "Cancel" }), void 0),
                            jsx(Button, __assign({ variant: "contained", style: { marginLeft: "12px" }, onClick: function () { return props.onClose(webSite); }, color: "primary", disabled: !canClose }, { children: "Ok" }), void 0)] }), void 0)] }), void 0);
        } }, void 0));
}
    ...
    return useObserver(function () {
        ...
        return (jsxs(Box, __assign({ p: 2, height: "100%", display: "flex", flexDirection: "column" }, { children: [jsxs(Toolbar, __assign({ style: { paddingRight: "0" } }, { children: [jsxs(Paper, __assign({ style: { marginLeft: "auto" }, elevation: 2 }, { children: [jsx(InputBase, { style: {
                ...
                jsx(Paper, __assign({ className: classes.root, elevation: 2 }, { children: jsx(TableContainer, __assign({ className: classes.container }, { children: jsxs(Table, __assign({ stickyHeader: true, "aria-label": "sticky table" }, { children: [jsx(TableHead, { children: jsxs(TableRow, { children: [jsx(TableCell, {}, void 0),
                                            ...
                                            jsx(TableCell, __assign({ style: { textAlign: "center" } }, { children: "\u8A73\u7D30" }), void 0)] }, void 0) }, void 0),
                                jsx(TableBody, { children: webSiteManagementsService.webSites.map(function (site, i) { return (jsxs(TableRow, { children: [jsx(TableCell, __assign({ padding: "checkbox" }, { children: jsx(Checkbox, { color: "primary" }, void 0) }), void 0),
                                            jsx(TableCell, { children: site.displayName }, void 0),
                                            jsx(TableCell, { children: site.name }, void 0),
                                            jsx(TableCell, __assign({ style: { textAlign: "center" } }, { children: jsx("a", __assign({ style: {
                                                        color: theme.palette.primary.main
                                                    }, target: "_blank", href: site.host }, { children: site.host }), void 0) }), void 0),
                                            jsx(TableCell, { children: site.description }, void 0),
                                            jsx(TableCell, __assign({ style: { textAlign: "center" } }, { children: jsx(IconButton, __assign({ onClick: function () { return editAsync(site); } }, { children: jsx(Icon, { children: "list" }, void 0) }), void 0) }), void 0)] }, i)); }) }, void 0)] }), void 0) }), void 0) }), void 0)] }), void 0));
    });
}
