import { aL as setPrototypeOf, aD as createCommonjsModule, aE as unwrapExports, aM as _typeof, b as createSvgIcon, g as __read, k as _assign, m as makeStyles, i as __awaiter, j as __generator, s as services, h as useObserver, R as Box, a9 as theme, a7 as Icon, V as axios, B as Button, I as IconButton, aN as commonjsGlobal, Y as _typeof$1, aO as objectAssign, p as propTypes, S as Select$1, ah as MenuItem, T as Typography } from './index-e5acb89e.js';
import { jsx, Fragment, jsxs } from 'react/jsx-runtime';
import { a as FileDropArea, P as PhotoGridView } from './ColorPalette-836d6e43.js';
...
import { S as Switch$1 } from './Switch-c56f04cc.js';
...
var assertThisInitialized$1 = unwrapExports(assertThisInitialized);
...
function ValidationTextField(props) {
    ...
    return jsx(TextField, _assign({}, props, { error: (isError || (props.required && !props.value)) && isChanged, value: props.value, onChange: function (e) { setIsChanged(true); handleChange(e.target.value); }, helperText: (props.required && !props.value) && isChanged ?
            "入力してください" :
            isError ?
                props.errorText :
...
var TextareaEditor = {
    fieldEditor: Area,
    schemeEditor: function () { return jsx(Fragment, {}, void 0); },
    type: "text-area",
    name: "テキストエリア",
...
function Area(props) {
    ...
    return (jsx(ValidationTextField, { fullWidth: true, rows: 8, variant: "outlined", multiline: true, helperText: props.helperText, errorText: "\u7121\u52B9\u306A\u5024\u3067\u3059", required: props.required, rules: props.rule, value: props.field.field.value, textChanged: function (e) { return handleChange(e.value); } }, void 0));
}
...
function MediaSelectionDialog(props) {
    ...
    return useObserver(function () {
        return (jsxs(Box, _assign({ position: "relative" }, { children: [jsx(Box, _assign({ p: 2, display: "flex", style: { background: theme.palette.background.paper }, width: "100%", zIndex: "999", position: "sticky", top: "0px" }, { children: jsxs(Tabs, _assign({ indicatorColor: "primary", variant: "fullWidth", value: selectedTab, style: { width: "100%" }, onChange: function (_, e) { return setSelectedTab(e); }, "aria-label": "setting" }, { children: [jsx(Tab, { icon: jsx(Icon, { children: "cloud_upload" }, void 0), label: "\u30A2\u30C3\u30D7\u30ED\u30FC\u30C9" }, void 0),
                            jsx(Tab, { icon: jsx(Icon, { children: "view_module" }, void 0), label: "\u753B\u50CF\u3092\u9078\u629E" }, void 0)] }), void 0) }), void 0),
                jsxs(SwipeableViews, _assign({ index: selectedTab, axis: "x", height: "100%", style: { height: "100%" }, onChangeIndex: function (_, e) { return setSelectedTab(e); } }, { children: [jsx(TabPanel, _assign({ value: selectedTab, index: 0 }, { children: jsx(Box, _assign({ p: 2, position: "relative", flex: "1 1 auto" }, { children: jsx(FileDropArea, { onChange: function (e) { return setFile(e); } }, void 0) }), void 0) }), void 0),
                        jsx(TabPanel, _assign({ value: selectedTab, index: 1 }, { children: jsx(PhotoGridView, { selected: selected, multiSelect: context === null || context === void 0 ? void 0 : context.multiple, selectionChanged: function (selected) { return setSelected(selected); }, images: services.mediaService.files, baseUrl: axios.defaults.baseURL, hideCheckbox: true, disableInvok: true }, void 0) }), void 0)] }), void 0),
                jsxs(Box, _assign({ p: 1, display: "flex", style: { background: theme.palette.background.paper }, width: "100%", position: "sticky", bottom: "0px" }, { children: [jsx(Box, { flex: "1 1 auto" }, void 0),
                        jsx(Button, _assign({ onClick: function () { return props.onClose([]); }, color: "primary" }, { children: "Cancel" }), void 0),
                        jsx(Button, _assign({ style: { marginLeft: "4px" }, disabled: (selectedTab === 1 && !selected.length) || (selectedTab === 0 && !file), onClick: function () {
...
function Image(props) {
    ...
    return (jsx(Fragment, { children: jsxs(Box, _assign({ display: "flex", justifyContent: "center", flexDirection: "column" }, { children: [!props.field.field.value ?
                    jsx(Box, _assign({ mt: 2, mx: 2, display: "flex", flexDirection: "column", alignItems: "center" }, { children: jsx(Button, _assign({ style: { marginTop: "8px" }, variant: "contained", color: "primary", onClick: function () {
                                selectAsync();
                            } }, { children: "\u753B\u50CF\u3092\u9078\u629E" }), void 0) }), void 0)
                    :
                        jsx("img", { alt: "preview", height: "280", src: axios.defaults.baseURL + props.field.field.value, style: { width: "100%", objectFit: "cover" } }, void 0),
                jsx(Box, _assign({ mt: 2, display: "flex" }, { children: props.field.field.value && jsx(Button, _assign({ color: "primary", onClick: function () {
                            handleChange("");
...
function PhotoGallery(props) {
    ...
    return (jsxs(Box, { children: [jsxs(Box, _assign({ display: "flex" }, { children: [jsx(IconButton, _assign({ disabled: !selected.length, color: "primary", size: "small", style: { marginLeft: "auto" }, onClick: function () { return removeSelected(); } }, { children: jsx(Delete, {}, void 0) }), void 0),
                    jsx(IconButton, _assign({ disabled: !!selected.length, color: "primary", size: "small", onClick: function () { return addMedia(); } }, { children: jsx(Add, {}, void 0) }), void 0)] }), void 0),
            jsx(Box, _assign({ height: "368px", width: "100%", mt: 1, overflow: "hidden", style: {
                    overflowY: "auto",
                    position: "relative",
                    borderRadius: "2px",
                    background: "rgba(127,127,127,0.09)",
                } }, { children: jsx(PhotoGridView, { disableInvok: true, hideCheckbox: true, itemHeight: 90, span: 1, images: props.field.field.value.split(",").filter(function (x) { return !!x; }), selected: selected, baseUrl: axios.defaults.baseURL, multiSelect: true, selectionChanged: function (e) { return setSelected(e); } }, void 0) }), void 0)] }, void 0));
}
    ...
    return (
      ...
      function (module, exports, __webpack_require__) {
        ...
        Delta.prototype.insert = function (text, attributes) {
          ...
          if (attributes != null && _typeof$1(attributes) === 'object' && Object.keys(attributes).length > 0) {
          ...
          if (_typeof$1(lastOp) === 'object') {
            ...
            if (equal(newOp.attributes, lastOp.attributes)) {
              if (typeof newOp.insert === 'string' && typeof lastOp.insert === 'string') {
                ...
                if (_typeof$1(newOp.attributes) === 'object') this.ops[index - 1].attributes = newOp.attributes;
                return this;
      ...
      function (module, exports) {
        ...
        module.exports = function extend() {
          ...
          if (target == null || _typeof$1(target) !== 'object' && typeof target !== 'function') {
            target = {};
          }
      ...
      function (module, exports, __webpack_require__) {
        ...
        var deepEqual = module.exports = function (actual, expected, opts) {
          ...
          } else if (!actual || !expected || _typeof$1(actual) != 'object' && _typeof$1(expected) != 'object') {
        ...
        function isBuffer(x) {
          if (!x || _typeof$1(x) !== 'object' || typeof x.length !== 'number') return false;
        ...
        function objEquiv(a, b, opts) {
          ...
          return _typeof$1(a) === _typeof$1(b);
        }
        /***/
        ...
        var lib = {
          attributes: {
            compose: function compose(a, b, keepNull) {
              if (_typeof$1(a) !== 'object') a = {};
              if (_typeof$1(b) !== 'object') b = {};
            ...
            transform: function transform(a, b, priority) {
              if (_typeof$1(a) !== 'object') return b;
              if (_typeof$1(b) !== 'object') return undefined;
      ...
      function (module, exports) {
        var clone = function () {
          ...
          */
          ...
          function __isDate(o) {
            return _typeof$1(o) === 'object' && __objToStr(o) === '[object Date]';
          }

          clone.__isDate = __isDate;

          function __isArray(o) {
            return _typeof$1(o) === 'object' && __objToStr(o) === '[object Array]';
          }

          clone.__isArray = __isArray;

          function __isRegExp(o) {
            return _typeof$1(o) === 'object' && __objToStr(o) === '[object RegExp]';
          }
      ...
      function (module, exports) {
        ...
        function unsupported(object) {
          return object && _typeof$1(object) == 'object' && typeof object.length == 'number' && Object.prototype.hasOwnProperty.call(object, 'callee') && !Object.prototype.propertyIsEnumerable.call(object, 'callee') || false;
        }
        /***/
      },
      /* 54 */
...
function factory(ReactComponent, isValidElement, ReactNoopUpdateQueue) {
  ...
  function mergeIntoWithNoDuplicateKeys(one, two) {
    _invariant(one && two && _typeof$1(one) === 'object' && _typeof$1(two) === 'object', 'mergeIntoWithNoDuplicateKeys(): Cannot merge non-objects.');
  ...
  function createClass(spec) {
    ...
    var Constructor = identity(function (props, context, updater) {
      ...
      _invariant(_typeof$1(initialState) === 'object' && !Array.isArray(initialState), '%s.getInitialState(): must return an object or null', Constructor.displayName || 'ReactCompositeComponent');
...
function isSymbol(value) {
  return _typeof$1(value) == 'symbol' || isObjectLike_1(value) && _baseGetTag(value) == symbolTag$1;
}
...
function RitchEditor(props) {
    return (jsx(lib, { value: props.content, theme: "snow", modules: {
            toolbar: toolbarOptions,
        }, onChange: function (e) { return props.contentChanged(e); } }, void 0));
}
...
function Rich(props) {
    ...
    return (jsx(RitchEditor, { content: props.field.field.value, contentChanged: function (e) { return handleChange(e); } }, void 0));
}
...
function Select(props) {
    ...
    return (jsx(Select$1, _assign({ fullWidth: true, variant: "outlined", required: props.required, value: props.field.field.value, onChange: function (e) { return handleChange(e.target.value); } }, { children: selection.map(function (text) { return (jsx(MenuItem, _assign({ value: text }, { children: text }), void 0)); }) }), void 0));
}
function SelectScheme(props) {
    ...
    return (jsxs(Fragment, { children: [jsx(Typography, { children: "\u9078\u629E\u80A2" }, void 0),
            jsx(TextField, { fullWidth: true, rows: "4", multiline: true, variant: "filled", value: props.scheme.metadata, onChange: function (e) { return handleChange(e.target.value); }, helperText: "\u300C,\u300D\u30AB\u30F3\u30DE\u533A\u5207\u308A\u3067\u9078\u629E\u80A2\u3092\u8B2C\u529B\u3057\u3066\u304F\u3060\u3055\u3044" }, void 0)] }, void 0));
}
...
function Switch(props) {
    ...
    return (jsx(Fragment, { children: jsx(Switch$1, { color: "primary", checked: props.field.field.value === "1", onChange: function (e) { return handleChange(e.target.checked ? "1" : "0"); } }, void 0) }, void 0));
}
...
function Text$1(props) {
    ...
    return (jsx(ValidationTextField, { fullWidth: true, variant: "outlined", helperText: props.helperText, errorText: "\u7121\u52B9\u306A\u5024\u3067\u3059", required: props.required, rules: props.rule, value: props.field.field.value, textChanged: function (e) { return handleChange(e.value); } }, void 0));
}
