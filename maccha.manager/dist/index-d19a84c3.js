import { aA as _setPrototypeOf, aB as _typeof, aw as _assertThisInitialized, b as createSvgIcon, g as __read, k as __assign, m as makeStyles, i as __awaiter, j as __generator, s as services, h as useObserver, R as Box, a0 as theme, Z as Icon, V as axios, B as Button, I as IconButton, aC as createCommonjsModule, aD as commonjsGlobal, aE as objectAssign, p as propTypes, S as Select$1, a8 as MenuItem, T as Typography } from './index-ef27c13e.js';
import { jsx, Fragment, jsxs } from 'react/jsx-runtime';
import { a as FileDropArea, P as PhotoGridView } from './ColorPalette-7aa41a3c.js';
import { s as showDialogAsync } from './showDialog-ce430e7c.js';
import React, { createElement, useState, useEffect } from 'react';
import { T as TextField } from './TextField-d5a06b92.js';
import { T as Tabs, a as Tab, S as SwipeableViews } from './index-c7b47ecf.js';
import { c as confirmAsync } from './confirmAsync-41fb687a.js';
import { A as Add } from './Add-3a1653cc.js';
import ReactDOM from 'react-dom';
import ReactDOMServer from 'react-dom/server';
import { S as Switch$1 } from './Switch-50f3fec9.js';
...
function ValidationTextField(props) {
    ...
    return jsx(TextField, __assign({}, props, { error: (isError || (props.required && !props.value)) && isChanged, value: props.value, onChange: function (e) { setIsChanged(true); handleChange(e.target.value); }, helperText: (props.required && !props.value) && isChanged ?
            "入力してください" :
            isError ?
                props.errorText :
...
function MediaSelectionDialog(props) {
    ...
    return useObserver(function () {
        return (jsxs(Box, __assign({ position: "relative" }, { children: [jsx(Box, __assign({ p: 2, display: "flex", style: { background: theme.palette.background.paper }, width: "100%", zIndex: "999", position: "sticky", top: "0px" }, { children: jsxs(Tabs, __assign({ indicatorColor: "primary", variant: "fullWidth", value: selectedTab, style: { width: "100%" }, onChange: function (_, e) { return setSelectedTab(e); }, "aria-label": "setting" }, { children: [jsx(Tab, { icon: jsx(Icon, { children: "cloud_upload" }, void 0), label: "\u30A2\u30C3\u30D7\u30ED\u30FC\u30C9" }, void 0),
                            jsx(Tab, { icon: jsx(Icon, { children: "view_module" }, void 0), label: "\u753B\u50CF\u3092\u9078\u629E" }, void 0)] }), void 0) }), void 0),
                jsxs(SwipeableViews, __assign({ index: selectedTab, axis: "x", height: "100%", style: { height: "100%" }, onChangeIndex: function (_, e) { return setSelectedTab(e); } }, { children: [jsx(TabPanel, __assign({ value: selectedTab, index: 0 }, { children: jsx(Box, __assign({ p: 2, position: "relative", flex: "1 1 auto" }, { children: jsx(FileDropArea, { onChange: function (e) { return setFile(e); } }, void 0) }), void 0) }), void 0),
                        jsx(TabPanel, __assign({ value: selectedTab, index: 1 }, { children: jsx(PhotoGridView, { selected: selected, multiSelect: context === null || context === void 0 ? void 0 : context.multiple, selectionChanged: function (selected) { return setSelected(selected); }, images: services.mediaService.files, baseUrl: axios.defaults.baseURL, hideCheckbox: true, disableInvok: true }, void 0) }), void 0)] }), void 0),
                jsxs(Box, __assign({ p: 1, display: "flex", style: { background: theme.palette.background.paper }, width: "100%", position: "sticky", bottom: "0px" }, { children: [jsx(Box, { flex: "1 1 auto" }, void 0),
                        jsx(Button, __assign({ onClick: function () { return props.onClose([]); }, color: "primary" }, { children: "Cancel" }), void 0),
                        jsx(Button, __assign({ style: { marginLeft: "4px" }, disabled: (selectedTab === 1 && !selected.length) || (selectedTab === 0 && !file), onClick: function () {
...
function Image(props) {
    ...
    return (jsx(Fragment, { children: jsxs(Box, __assign({ display: "flex", justifyContent: "center", flexDirection: "column" }, { children: [!props.field.field.value ?
                    jsx(Box, __assign({ mt: 2, mx: 2, display: "flex", flexDirection: "column", alignItems: "center" }, { children: jsx(Button, __assign({ style: { marginTop: "8px" }, variant: "contained", color: "primary", onClick: function () {
                                selectAsync();
                ...
                jsx(Box, __assign({ mt: 2, display: "flex" }, { children: props.field.field.value && jsx(Button, __assign({ color: "primary", onClick: function () {
                            handleChange("");
...
function PhotoGallery(props) {
    ...
    return (jsxs(Box, { children: [jsxs(Box, __assign({ display: "flex" }, { children: [jsx(IconButton, __assign({ disabled: !selected.length, color: "primary", size: "small", style: { marginLeft: "auto" }, onClick: function () { return removeSelected(); } }, { children: jsx(Delete, {}, void 0) }), void 0),
                    jsx(IconButton, __assign({ disabled: !!selected.length, color: "primary", size: "small", onClick: function () { return addMedia(); } }, { children: jsx(Add, {}, void 0) }), void 0)] }), void 0),
            jsx(Box, __assign({ height: "368px", width: "100%", mt: 1, overflow: "hidden", style: {
                    overflowY: "auto",
                    position: "relative",
                    borderRadius: "2px",
...
function Select(props) {
    ...
    return (jsx(Select$1, __assign({ fullWidth: true, variant: "outlined", required: props.required, value: props.field.field.value, onChange: function (e) { return handleChange(e.target.value); } }, { children: selection.map(function (text) { return (jsx(MenuItem, __assign({ value: text }, { children: text }), void 0)); }) }), void 0));
}
