import { aK as _inheritsLoose, Y as _objectWithoutPropertiesLoose, aL as Transition, a as _extends, aM as classNamesShape, p as propTypes, m as makeStyles, w as withStyles, _ as _objectWithoutProperties, c as clsx, B as Button, ah as createStyles, aN as Popover, I as IconButton, T as Typography, aO as SvgIcon, av as _classCallCheck, au as _createClass, aP as TransitionGroup, u as useTheme, ac as _defineProperty, K as _slicedToArray, M as fade, aQ as Toolbar, aC as createCommonjsModule, aJ as getDefaultExportFromCjs, a3 as useRouteMatch, f as useHistory, g as __read, R as Box, k as __assign, S as Select, a8 as MenuItem, U as Divider, aR as StatusType, aS as DateTime_1, V as axios, i as __awaiter, j as __generator, Z as Icon, s as services, a4 as ObserverComponent } from './index-ef27c13e.js';
...
import { _ as _inherits, a as _possibleConstructorReturn, b as _getPrototypeOf, s as showMediaSelectionDialog, e as editors } from './index-d19a84c3.js';
import { a as postStatusTypes } from './PostStatusType-7aa3a827.js';
import { S as Switch } from './Switch-50f3fec9.js';
import { a as Dialog, b as DialogContent, c as DialogActions } from './showDialog-ce430e7c.js';
import { C as CircularProgress } from './ColorPalette-7aa41a3c.js';
import { I as InputAdornment } from './InputAdornment-40cf9dbe.js';
...
function PostEditOptionPanel(props) {
    ...
    return (jsxs(Fragment$1, { children: [jsxs(Box, __assign({ width: "100%", display: "flex", mt: 1 }, { children: [jsx(Select, __assign({ color: "primary", style: { flex: "1 1 auto" }, value: contentEditContext.status, onChange: function (e) { return setcontentEditContextParam("status", e.target.value); } }, { children: postStatusTypes.map(function (t) { return (jsx(MenuItem, __assign({ value: t.value }, { children: t.display }), t.value)); }) }), void 0),
                    jsx(Button, __assign({ style: { marginLeft: "8px" }, onClick: publishAsync, color: "primary", variant: "contained" }, { children: "\u6295\u7A3F" }), void 0)] }), void 0),
            jsx(Box, __assign({ mt: 3 }, { children: jsx(Divider, {}, void 0) }), void 0),
            contentEditContext.status !== StatusType.Drafting && (jsxs(Box, __assign({ width: "100%", mt: 3 }, { children: [jsx(Typography, __assign({ color: "textSecondary" }, { children: "\u516C\u958B\u6642\u9593\u4E88\u7D04" }), void 0),
                    jsxs(Box, __assign({ display: "flex", alignItems: "center" }, { children: [jsx(Switch, { color: "primary", checked: isReservationed, onChange: function (e) {
                                    setcontentEditContextParam("publishIn", DateTime_1.local());
                                    setIsReservation(e.target.checked);
                                } }, void 0), isReservationed ? "ON" : "OFF"] }), void 0),
                    isReservationed && jsx(Fragment$1, { children: jsxs(MuiPickersUtilsProvider, __assign({ utils: DateFnsUtils }, { children: [jsx(KeyboardDatePicker, { margin: "normal", id: "date-picker-dialog", label: "\u516C\u958B\u65E5", format: "MM/dd/yyyy", value: (_a = contentEditContext.publishIn) === null || _a === void 0 ? void 0 : _a.toJSDate(), onChange: function (e) { var _a; return setcontentEditContextParam("publishIn", DateTime_1.fromISO((_a = e === null || e === void 0 ? void 0 : e.toISOString()) !== null && _a !== void 0 ? _a : "")); }, KeyboardButtonProps: {
                                        "aria-label": "change date",
                                    } }, void 0),
                                jsx(KeyboardTimePicker, { margin: "normal", id: "time-picker", label: "\u516C\u958B\u6642\u9593", value: (_b = contentEditContext.publishIn) === null || _b === void 0 ? void 0 : _b.toJSDate(), onChange: function (e) { var _a; return setcontentEditContextParam("publishIn", DateTime_1.fromISO((_a = e === null || e === void 0 ? void 0 : e.toISOString()) !== null && _a !== void 0 ? _a : "")); }, KeyboardButtonProps: {
                                        "aria-label": "change time",
                                    } }, void 0)] }), void 0) }, void 0)] }), void 0)),
            jsxs(Box, __assign({ width: "100%", mt: 3 }, { children: [jsx(Typography, __assign({ color: "textSecondary", variant: "overline" }, { children: "\u30BF\u30A4\u30C8\u30EB" }), void 0),
            ...
            jsxs(Box, __assign({ width: "100%", mt: 2 }, { children: [jsxs(Box, __assign({ display: "flex" }, { children: [jsx(Typography, __assign({ color: "textSecondary", variant: "overline" }, { children: "\u30B5\u30E0\u30CD\u30A4\u30EB" }), void 0),
                            jsx(Button, __assign({ variant: "text", color: "primary", size: "small", disabled: !contentEditContext.thumbnail, style: { marginLeft: "auto" }, onClick: function () { return setcontentEditContextParam("thumbnail", ""); } }, { children: "\u30AF\u30EA\u30A2" }), void 0)] }), void 0),
                    jsxs(Box, __assign({ height: "120px", width: "100%", mt: 1, overflow: "hidden", style: {
                            position: "relative",
                            borderRadius: "2px",
                            ...
                            jsx(Button, __assign({ variant: "text", color: "primary", onClick: function () { return selectMedia(); }, style: {
                                    position: "absolute",
                                    left: 0,
                                    right: 0,
                                    bottom: 0,
            ...
            jsxs(Box, __assign({ mt: 2 }, { children: [jsx(Typography, __assign({ color: "textSecondary", variant: "overline" }, { children: "\u5099\u8003" }), void 0),
            ...
            jsxs(Box, __assign({ mt: 2 }, { children: [jsx(Typography, __assign({ color: "textSecondary", variant: "overline" }, { children: "\u30E1\u30BF\u30C7\u30FC\u30BF" }), void 0),
...
function PostEditPage() {
    ...
    return jsx(ObserverComponent, { children: function () {
            ...
            return postEditService.content && (jsxs(Box, __assign({ display: "flex", position: "relative", height: "100%" }, { children: [jsx(Box, __assign({ p: 2, flex: "1 1 auto", overflow: "hidden", height: "100%", style: { overflowY: "auto" }, display: "flex", alignItems: "center", flexDirection: "column" }, { children: (_a = services.postManagementsService.selected) === null || _a === void 0 ? void 0 : _a.taxonomy.schemes.map(function (scheme) {
                            var _a;
                            var f = (_a = postEditService.content) === null || _a === void 0 ? void 0 : _a.fields.find(function (s) { return s.schemeId === scheme.schemeId; });
                            if (!f) {
                                return jsxs(Box, __assign({ className: "post", maxWidth: "100%", width: "780px", mt: 2 }, { children: [jsxs(Typography, __assign({ color: "error" }, { children: ["\"", scheme.name, " - ", scheme.displayName, "\" \u306E\u8AAD\u307F\u8FBC\u307F\u306B\u5931\u6557\u3057\u307E\u3057\u305F"] }), void 0),
                                        jsx(Box, { mt: 2 }, void 0),
                                        jsx(Divider, {}, void 0)] }), scheme.schemeId);
                            }
                            return jsxs(Box, __assign({ className: "post", maxWidth: "100%", width: "780px", mt: 2 }, { children: [jsxs(Typography, __assign({ variant: "h5", style: { wordBreak: "break-all" } }, { children: [scheme.name, " - ", scheme.displayName] }), void 0),
                                    jsx(Divider, {}, void 0),
                                    jsx(Box, { mt: 2 }, void 0),
                                    jsx(Typography, __assign({ color: "textSecondary", variant: "caption" }, { children: scheme.description }), void 0),
                                    jsx(Box, { mt: 2 }, void 0),
                    ...
                    jsx(Box, __assign({ p: 2, minWidth: "300px", maxWidth: "300px", overflow: "auto" }, { children: jsx(PostEditOptionPanel, { contentEditContext: postEditService.content }, void 0) }), void 0)] }), void 0));
        } }, void 0);
}
